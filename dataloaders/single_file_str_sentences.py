...
class MyDataset(Dataset):
    ...
    def preprocess_sentences(self):
        sentences_file = self.opt.data_dir + self.opt.input_file + '.sentences.preprocess'
        if not os.path.isfile(sentences_file):
            ...
            self.sentences = [sentence for sentence in self.sentences if len(sentence)>self.MINIMUM_LEN_SENTENCE]
