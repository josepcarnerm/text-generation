...
jobs = [
    ...
    #  'epoch_size': 100, 'n_epochs': 500, 'hidden_size_rnn': 100, 'n_layers_rnn': 2, 'sentence_len': 20, 'loss_alpha': 0.99,
    #  'reuse_pred': '', 'use_pretrained_embeddings': '', 'bidirectional':'', 'glove_dir': 'data/glove.6B/glove.6B.100d.txt',
    #  'baseline_model': '/data/jcm807/batch_size=128-char_ngram=2-dataloader=multi_file_str-dropout=0.4'
    #                    '-hidden_size_rnn=100-input_folder_path=data_gutenberg-lrt=0.0001-model=word_rnn'
    #                    '-n_layers_rnn=2-reuse_pred=True-sentence_len=20-use_pretrained_embeddings=True/checkpoint',
    #  },
    ...
    #  },
    # {'dataloader': 'multi_file_str', 'model': 'word_rnn_topic_closest_word_to_rest', 'batch_size': 128, 'lrt': 0.0001,
    #  'epoch_size': 100, 'n_epochs': 500, 'hidden_size_rnn': 100, 'n_layers_rnn': 2, 'sentence_len': 20, 'loss_alpha': 0.999,
    #  'reuse_pred': '', 'use_pretrained_embeddings': '', 'bidirectional':'', 'glove_dir': 'data/glove.6B/glove.6B.100d.txt',
    #  'baseline_model': '/data/jcm807/batch_size=128-char_ngram=2-dataloader=multi_file_str-dropout=0.4'
    #                    '-hidden_size_rnn=100-input_folder_path=data_gutenberg-lrt=0.0001-model=word_rnn'
    #                    '-n_layers_rnn=2-reuse_pred=True-sentence_len=20-use_pretrained_embeddings=True/checkpoint',
