...
jobs = [
    ...
    {'dataloader': 'multi_file_str', 'model': 'word_rnn_topic_closest_word_to_rest', 'batch_size': 64, 'lrt': 0.0001,
     'epoch_size': 1, 'n_epochs': 1, 'hidden_size_rnn': 200, 'n_layers_rnn': 4, 'sentence_len': 20, 'loss_alpha': 0.8,
     'dropout': 0.2, 'use_pretrained_embeddings': '', 'bidirectional':'', 'glove_dir': 'data/glove.6B/glove.6B.200d.txt',
     'baseline_model': '/data/jcm807/batch_size=256-bidirectional=True-char_ngram=2-dataloader=multi_file_str-dropout=0.2-hidden_size_rnn=200-lrt=0.0001-model=word_rnn-n_layers_rnn=4-reuse_pred=False-sentence_len=20-use_pretrained_embeddings=True/checkpoint',
     },
    {'dataloader': 'multi_file_str', 'model': 'word_rnn_topic_least_frequent_word', 'batch_size': 64, 'lrt': 0.0001,
    ...
    {'dataloader': 'multi_file_str', 'model': 'word_rnn_topic_closest_word_to_rest', 'batch_size': 64, 'lrt': 0.0001,
     'epoch_size': 1, 'n_epochs': 1, 'hidden_size_rnn': 200, 'n_layers_rnn': 4, 'sentence_len': 20, 'loss_alpha': 0.2,
     'dropout': 0.2, 'use_pretrained_embeddings': '', 'bidirectional':'', 'glove_dir': 'data/glove.6B/glove.6B.200d.txt',
     'baseline_model': '/data/jcm807/batch_size=256-bidirectional=True-char_ngram=2-dataloader=multi_file_str-dropout=0.2-hidden_size_rnn=200-lrt=0.0001-model=word_rnn-n_layers_rnn=4-reuse_pred=False-sentence_len=20-use_pretrained_embeddings=True/checkpoint',
     },
    {'dataloader': 'multi_file_str', 'model': 'word_rnn_topic_least_frequent_word', 'batch_size': 64, 'lrt': 0.0001,
