...
jobs = [
    ...
    {'dataloader': 'single_file_str_words', 'model': 'word_rnn_topic', 'batch_size': 10, 'lrt': 0.01, 'epoch_size': 1,
     'n_epochs': 400, 'hidden_size_rnn': 11, 'n_layers_rnn': 2, 'sentence_len': 5, 'loss_alpha': 0.15},
